...
from infa.models import User

from infa.models import Post,Comment

from rest_framework import serializers

from infa.permissions import IsOwnerOnly
...
class SignUpApiView(APIView):
    ...
    def post(self,request,*args,**kwargs):
        ...
        #deserialization=user data into qs
...
class PostViewSetView(ViewSet):
        ...
        def create(self,request,*args,**kwargs):
             ...
             if serializer_instance.is_valid():
                  ...
                  #integrity error not null constraint failed infa_models_post_owner
